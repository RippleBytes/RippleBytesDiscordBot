...
from .views import AllRecord,Leave,Filter,loginuser,logoutuser,Registeruser,PersonalRecord,EmployeeInformation
...
urlpatterns=[
    ...
    path('register/employee_info/',EmployeeInformation.as_view(),name='employee_info')
]