...
class RegistrationForm(UserCreationForm):
    ...
    job_title=forms.CharField(max_length=20,widget=forms.widgets.TextInput(attrs={'class':'form-control','placeholder':'Full-stack developer,Front-end developer,Back-end developer','name':'job_title'}))
    phone_number=forms.CharField(max_length=10,widget=forms.widgets.NumberInput(attrs={'class':'form-control','placeholder':'9841000000','name':'phone_number'}))
    ...
    employee_citizenship_number=forms.CharField(max_length=15,widget=forms.TextInput(attrs={'class':'form-control','placeholder':'**-**-**-*****','name':'employee_citizenship_number'}))
