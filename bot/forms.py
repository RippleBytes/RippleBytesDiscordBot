...
from .models import LeaveRequest,BankDetail,User
...
('Deva Bikas Bank Ltd.', 'Deva Bikas Bank Ltd.'),
...
('Infinity Laghubitta Bittiya Sanstha Ltd.', 'Infinity Laghubitta Bittiya Sanstha Ltd.'),
('Janata Bank Nepal Ltd.', 'Janata Bank Nepal Ltd.'),
('Jyoti Bikas Bank Ltd.', 'Jyoti Bikas Bank Ltd.'),
('Kailash Bikas Bank Ltd.', 'Kailash Bikas Bank Ltd.'),
...
('Nepal Community Development Bank Ltd.', 'Nepal Community Development Bank Ltd.'),
...
('Sahara Bikas Bank Ltd.', 'Sahara Bikas Bank Ltd.'),
...
class RegistrationForm(UserCreationForm):
    ...
    username=forms.CharField(max_length=100,widget=forms.widgets.TextInput(attrs={'class':'form-control','placeholder':'abc','name':'email'}))
    ...
    class Meta:
        model=User
        fields=('username','email','first_name','last_name','discord_user_id','job_title','private_email','phone_number','gender','date_of_birth','password1','password2','employee_citizenship_number','employee_citizenship_photo','employee_resume_pdf','employee_pp_photo')
        help_texts = {
            'username': None,
            'email': None,
